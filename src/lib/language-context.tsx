...
const translations: Translations = {
  en: {
    ...
    'home.hero.trust': 'Trusted by 10,000+ Students',
    ...
    'home.section.subtitle': 'Experience education reimagined with our innovative learning platform',
    'home.feature1.title': 'Interactive Learning',
    'home.feature1.desc': 'Engage with interactive materials including videos, simulations, and quizzes that make learning both effective and enjoyable.',
    'home.feature2.title': 'Personalized Experience',
    'home.feature2.desc': 'Receive tailored content that adapts to your learning pace, strengths, and areas for improvement.',
    'home.feature3.title': 'Learn Anywhere',
    'home.feature3.desc': 'Access your courses on any device with our mobile-friendly platform, enabling learning on your schedule.',
    'home.blogs.title': 'Latest Insights',
    'home.blogs.subtitle': 'Discover our latest articles and stay updated with educational trends',
  ...
  am: {
    ...
    'home.feature1.desc': 'ትምህርቱን ውጤታማና አስደሳች የሚያደርጉ ተግባራዊ ቁሳቁሶችን ያካተቱ ቪዲዮዎች፣ ሲሙሌሽኖች እና ፈተናዎች ይሳተፉ።',
    'home.feature2.title': 'የግል ተሞክሮ',
    'home.feature2.desc': 'ከመማር ፍጥነትዎ፣ ጥንካሬዎችዎ እና ማሻሻያ የሚያስፈልጋቸው ቦታዎች ጋር የሚስማማ ይዘት ይቀበሉ።',
    'home.feature3.title': 'በየትም ይማሩ',
    'home.feature3.desc': 'በዕቅድዎ መሰረት መማርን የሚያስችሉ የእኛ ሞባይል-ፈቃደኛ መድረክ ላይ በማንኛውም መሣሪያ ኮርሶችዎን ይጠቀሙ።',
    'home.blogs.title': 'የቅርብ ግዜ ግንዛቤዎች',
    'home.blogs.subtitle': 'የቅርብ ጊዜ አጫጭር ጽሑፎቻችንን ይመልከቱ እና በትምህርታዊ ዝንባሌዎች ተዘመን ይሁኑ',
  ...
  om: {
    ...
    'home.section.subtitle': 'Platformii barumsaa keenyaa haaraa irratti barnootaan muuxannoo haaraa argadhu',
    'home.feature1.title': 'Barumsa Waliigalaa',
    'home.feature1.desc': 'Meeshaalee waliigalaa keessatti hirmaachuu kan dabalatu viidiyoowwan, fakkeessitoota, fi qormaatota barumsichi bu\'a-qabeessaafi gammachisaa akka ta\'u godhu.',
    'home.feature2.title': 'Muuxannoo Dhuunfaa',
    'home.feature2.desc': 'Qabiyyee aartii barumsa keessanii, cimina keessanii, fi bakkeewwan fooyya insaa barbaaduun walsimatu argadhaa.',
    'home.feature3.title': 'Bakka Maratti Baradhu',
    'home.feature3.desc': 'Platformii keenya mobaayilii-marii qabu irratti sagantaa keessan irratti barachuu dandeessisuun meeshaa kamiyyuu irratti koorsiiwwan keessan argadhaa.',
    'home.blogs.title': 'Hubannoo Haaraa',
    'home.blogs.subtitle': 'Barreewwan keenya kan dhiyoo argadhaa, dubbadhaa, qooda kennaa',
  ...
  ti: {
    ...
    'home.feature1.desc': 'ምስ ተሳታፋይ ናውቲ ከም ቪድዮታት፣ ምምስሳላትን ኽውንነት ፈተናታትን ዘጠቓለለ፣ ትምህርቲ ውጽኢታውን ኣዝዩ ሓጎስን ዝገብርዎ።',
    'home.feature2.title': 'ናይ ውልቂ ተመኩሮ',
    'home.feature2.desc': 'ምስ ናይ ምምሃር ፍጥነትካ፣ ሓይልታትካን ኣብ ምምሕያሽ ዘድልዮም ቦታታትን ዝሰማማዕ ትሕዝቶ ተቐበል።',
    'home.feature3.title': 'ኣብ ኩሉ ቦታ ተምሃር',
    'home.feature3.desc': 'ብናትካ ናይ ጊዜ ሰሌዳ ተምሃር ንምኽኣል ብናትና ኣብ ሞባይል ዝሰርሓሉ መድረኽ ኣብ ዝኾነ መሳርሒ ኮርሳትካ ተጠቐም።',
