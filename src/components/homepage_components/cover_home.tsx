...
export default function CoverHome() {
  return (
    <div className="relative h-[90dvh] w-full md:pt-32 bg-[url(/Background/landing-bg.jpg)] bg-cover bg-center flex flex-col items-center">

      <h1 className="sr-only">let&lsquo;s embark on this knowledge journey!</h1>

      <div className="px-6 flex flex-col w-full md:max-w-5xl absolute top-1/2 md:top-[65%] z-10 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
        <h1 className="relative w-full md:max-w-4xl mb-4 text-5xl md:text-6xl lg:text-[5.2rem] leading-[1.2] text-white header font-Sendako uppercase">
          ...
          <Image
            ...
            width={20}
            height={20}
            className="w-12 md:w-20 h-12 md:h-20 absolute -top-6 md:-top-12 left-0 md:-left-6 pointer-events-none"
          />
        </h1>
        <Image
