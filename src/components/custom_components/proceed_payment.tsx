  ...
  export function ProceedPayment(props: any) {
    ...
    return (
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Are you sure you want to proceed to purchase?</AlertDialogTitle>
          </AlertDialogHeader>
          <div className="px-4 py-2">
            <label className="block text-sm mb-2">Phone Number (write in +251... format)</label>
            <input
              type="text"
              value={phoneNumber}
