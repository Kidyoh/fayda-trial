  ...
  const features = [
    {
      ...
      description:
        "Get immediate responses to your academic questions anytime.",
    },
    {
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8">
              Your intelligent assistant for a seamless educational experience.
              Get instant access to resources, track your progress, and connect
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/search"
                className="inline-flex items-center px-6 py-3 border border-gray-300 text-gray-700 rounded-full font-medium hover:bg-gray-50 transition duration-300 text-center justify-center"
              >
                Explore Courses
              </Link>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100 max-w-md">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="bg-gray-100 p-3 rounded-lg rounded-tl-none max-w-[80%]">
                    <p className="text-sm text-gray-700">
                      You have 2 assignments due this week for Mathematics and
                      Economics.
                    </p>
                  </div>
                </div>
      ...
      >
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            How Fayida Bot Can Help You
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our intelligent bot is designed to make your educational journey
      ...
      >
        <div className="bg-gradient-to-r from-primaryColor/90 to-primaryColor rounded-2xl p-8 md:p-12 shadow-xl text-center">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of students who are already using Fayida Academy Bot
            to enhance their education journey.
          </p>
          <a
            href="https://t.me/fayidaacademy_bot"
            target="_blank"
      ...
      >
        ...
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-2">
              How do I access the Fayida Academy Bot?
            </h3>
            <p className="text-gray-600">
              You can access our bot through Telegram by searching for
              @fayidaacademy_bot or clicking the "Start Using Bot" button above.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">
              Yes, our bot is available round the clock to help you with your
              questions and provide resources whenever you need them.
            </p>
          </div>

          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-2">
              What type of questions can I ask the bot?
            </h3>
            <p className="text-gray-600">
              You can ask questions about your courses, assignments, deadlines,
              learning materials, and even get help with certain academic
              topics.
            </p>
          </div>
        </div>
