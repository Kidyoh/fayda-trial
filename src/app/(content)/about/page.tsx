...
export default function AboutUs() {
  ...
  const features = [
    {
      ...
      description:
        "Learn from industry professionals and experienced educators who are passionate about sharing their knowledge and expertise.",
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: "Personalized Learning",
      description:
        "Customized learning paths that adapt to your pace and style, ensuring optimal progress and deep understanding.",
    },
    {
      icon: <Clock className="w-8 h-8" />,
      title: "Flexible Schedule",
      description:
        "Study anytime, anywhere with our on-demand courses and mobile-friendly platform designed for busy lifestyles.",
    },
  ];
  ...
  const values = [
    {
      ...
      description:
        "Building strong learning communities that support and inspire each other throughout the educational journey.",
    },
    {
      icon: <Lightbulb className="w-6 h-6" />,
      title: "Innovation-Driven",
      description:
        "Embracing cutting-edge technology and innovative teaching methods to enhance the learning experience.",
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Quality Assured",
      description:
        "Maintaining the highest standards of educational content and ensuring every course meets our excellence criteria.",
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Impact-Focused",
      description:
        "Creating real-world impact through practical education that transforms careers and lives across Ethiopia.",
    },
  ];
  ...
  const milestones = [
    {
      year: "2020",
      event: "Fayida Academy Founded",
      description: "Started with a vision to democratize education in Ethiopia",
    },
    {
      year: "2021",
    ...
    {
      year: "2022",
      event: "100+ Courses Launched",
      description: "Expanded our course catalog across multiple disciplines",
    },
    {
      year: "2023",
      event: "International Recognition",
      description: "Received awards for educational innovation in Africa",
    },
    {
      year: "2024",
      event: "10,000+ Graduates",
      description: "Celebrated over 10,000 successful course completions",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "Fayida Academy transformed my career. The programming courses were comprehensive and the instructors were incredibly supportive.",
      rating: 5,
    },
    {
      name: "Samuel Bekele",
      role: "Business Owner",
      content:
        "The business management courses helped me scale my startup. The practical approach made all the difference.",
      rating: 5,
    },
    {
      name: "Hanan Mohammed",
      role: "Teacher",
      content:
        "As an educator, I found the teaching methodology courses invaluable. They've enhanced my classroom techniques significantly.",
      rating: 5,
    },
  ];
          ...
          <div className="flex items-center justify-center mx-auto max-w-4xl">
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed max-w-3xl mx-auto">
                Empowering learners across Ethiopia and beyond with quality
                education that bridges traditional wisdom and modern innovation.
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <h3 className="text-3xl sm:text-4xl font-bold text-[#07705d] mb-2 relative z-10">
                  {stat.value}
                </h3>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#07705d] mb-6 font-Sendako">
              Our Mission
            </h2>
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-12 max-w-3xl mx-auto">
              ...
              of location or schedule. That&apos;s why we&apos;ve created a
              user-friendly platform that allows you to learn at your own pace,
              anytime, and anywhere. Our commitment is to provide quality
              education that transforms lives and opens doors to new
              opportunities across Ethiopia and beyond.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="p-8 bg-white rounded-2xl border border-gray-100 hover:border-[#07705d]/20 transition-all duration-300 hover:-translate-y-1 group relative overflow-hidden">
                ...
                <h3 className="text-xl font-bold text-[#07705d] mb-3 relative z-10 font-Sendako">
                  Accessibility
                </h3>
              ...
              <div className="p-8 bg-white rounded-2xl border border-gray-100 hover:border-[#bf8c13]/20 transition-all duration-300 hover:-translate-y-1 group relative overflow-hidden">
                ...
                <h3 className="text-xl font-bold text-[#bf8c13] mb-3 relative z-10 font-Sendako">
                  Excellence
                </h3>
                <p className="text-gray-600 relative z-10">
                  Maintaining the highest standards in course content and
              ...
              <div className="p-8 bg-white rounded-2xl border border-gray-100 hover:border-[#c7cc3f]/20 transition-all duration-300 hover:-translate-y-1 group relative overflow-hidden">
                ...
                <h3 className="text-xl font-bold text-[#c7cc3f] mb-3 relative z-10 font-Sendako">
                  Innovation
                </h3>
                <p className="text-gray-600 relative z-10">
                  Embracing modern technology to enhance traditional learning
                  methods.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#07705d] mb-4 font-Sendako">
              Why Choose Fayida Academy
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              Discover what makes our educational platform the preferred choice
              for learners across Ethiopia
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#07705d] mb-4 group-hover:text-[#bf8c13] transition-colors duration-300 relative z-10 font-Sendako">
                  {feature.title}
                </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-[#07705d] mb-3 group-hover:text-[#bf8c13] transition-colors duration-300 relative z-10 font-Sendako">
                  {value.title}
                </h3>
                  ...
                  <div key={index} className="relative flex items-center group">
                    ...
                    <div className="ml-20 p-6 bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 hover:border-[#07705d]/20 transition-all duration-300 w-full hover:-translate-y-1 relative overflow-hidden">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 relative z-10">
                        <h3 className="text-xl font-bold text-[#07705d] group-hover:text-[#bf8c13] transition-colors duration-300 font-Sendako">
                          {milestone.event}
                        </h3>
                        <span className="text-sm font-semibold text-[#bf8c13] bg-[#bf8c13]/10 px-3 py-1 rounded-full border border-[#bf8c13]/20">
                          {milestone.year}
                        </span>
                      </div>
                      <p className="text-gray-600 relative z-10">
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              Real stories from learners who have transformed their lives with
              Fayida Academy
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="flex items-center mb-4 relative z-10">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-4 h-4 text-[#bf8c13] fill-current"
                    />
                  ))}
                </div>
                ...
                <div className="border-t border-gray-100 pt-4 relative z-10">
                  <h4 className="font-bold text-[#07705d] font-Sendako">
                    {testimonial.name}
                  </h4>
      ...
      <section className="py-16 bg-[url(/Background/landing-bg.jpg)] bg-cover bg-center relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed max-w-3xl mx-auto">
              Start your learning journey today and unlock a world of
              possibilities. Join thousands of students who are already
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-white/20">
              <div className="text-center group">
                <div className="text-2xl sm:text-3xl font-bold text-[#c7cc3f] mb-1 group-hover:scale-110 transition-transform duration-300 font-Sendako">
                  24/7
                </div>
